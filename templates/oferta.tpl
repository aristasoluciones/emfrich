...
<body class="" >
		...
		<div id="sticker">
			<header id="header">
				<div  class="container">
					...
					<div class="logo"><a href="index.html"><img src="images/logo-1.png" width="" id="img-logo" alt="logo"></a></div>
					</div>		
	...
	<hr class="vertical-space4">
	  ...
	  <h4 class="extrabgsec"> <p align="justify">
		 ...
		 <font color="black" size="6">Ofertas de Valor</font>
		<br><br>
	 
		° Productos de calidad a través de precios accesibles. 
		<br>
		<br>
		° Servicio al cliente.
		<br>
		...
		<br>
		<br>
		° Tecnología de punta, lo cual mejora el proceso de productos de los alimentos. 
		<br>
		<br>
		° Fácil adquisición de los productos, debido a la localización de las sucursales.
		<br>
		<br>
