      ...
      <div id="layerslider" style="width: 100%; height: 300px; margin: 0px auto; ">
        ...
        <div class="ls-layer" style="slidedirection: right; slideoutdirection : top; slidedelay: 5000; durationin: 1500; durationout: 1500; delayout: 500;"> 
			...
			<img src="images/slide-emfrich/sliderpollo.png" class="ls-bg" alt="">
               ...
               <h1 class="ls-s3" style="position: absolute; top:100px; left: 700px; color:#fff; slidedirection : top; slideoutdirection : top; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 600;">
			    <div id="divRegistro" style=" background-color: rgba(54, 55, 58, 0.41); border-radius: 5px;" >
			   Cerdo - Res - Pollo
			   </div>
			   </h1><!--
