    ...
    <div id="layerslider-container-fw">
      <div id="layerslider" style="width: 100%; height: 300px; margin: 0px auto; ">
		 ...
		 <div class="ls-layer" style="slidedirection: top; slideoutdirection : top; slidedelay: 5000; durationin: 1500; durationout: 1500; delayout: 500;"> 
				...
				<h1 class="ls-s3" style="position: absolute; top:50px; left: 30px; color:white;  slidedirection : top; slideoutdirection : top; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 500;">EMFRICH</h1>
				<h4 class="ls-s3 l1-s1" style="position: absolute; top:130px; left: 30px; color:white; border-color:white;  slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 600; ">Comprometidos con la salud y el bienestar de las familias mexicanas</h4>     
        ...
        <div class="ls-layer" style="slidedirection: top; slidedelay: 6000; durationin: 1500; durationout: 1500; delayout: 500;">
          ...
          <h1 class="ls-s3" style="color:white; position: absolute; top:80px; left: 40%; slidedirection : right; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 400;">Producción, comercialización y distribución</h1>			
        ...
        <div class="ls-layer" style="slidedirection: right; slidedelay: 5000; durationin: 1500; durationout: 1500;">
			<img src="images/slide-emfrich/banner4.png" class="ls-bg" alt=""> 
    
          <h1 class="ls-s3" style="position: absolute; color:white; top:50px; font-weight:bold; left: 65%; slidedirection : right; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 400;">EMFRICH</h1><!--
        ...
        <div class="ls-layer" style="slidedirection: right; slideoutdirection : top; slidedelay: 5000; durationin: 1500; durationout: 1500; delayout: 500;"> 
			...
			<img src="images/slide-emfrich/sliderpollo.png" class="ls-bg" alt="">
     

     
               <h1 class="ls-s3" style="position: absolute; top:100px; left: 700px; color:#fff; slidedirection : top; slideoutdirection : top; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 600;">emfrich</h1><!--
